...
La serie **Landsat** es operada por la NASA y el USGS. Estos datos incluyen Landsat 5, 6, 8 y 9\. **Resolución espacial:** 30 metros. **Resolución temporal:** Mayor a 8 días, ya que dependiendo del satélite tienen un período de revisita de 8 o 16 días cada uno. 
