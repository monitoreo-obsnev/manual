...
\subsection{1. Accede a la herramienta de subida}\label{accede-a-la-herramienta-de-subida}
...
\section{\texorpdfstring{\protect\includegraphics{assets/gee2.png}}{}}\label{section}

\subsection{2. Sube el archivo}\label{sube-el-archivo}
...
\section{\texorpdfstring{\protect\includegraphics{assets/gee1.png}}{}}\label{section-1}

\subsection{3. Espera el procesamiento}\label{espera-el-procesamiento}
...
\subsection{4. Usa el asset en MonitorEO}\label{usa-el-asset-en-monitoreo}
