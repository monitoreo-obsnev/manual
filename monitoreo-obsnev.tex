...
\section{\texorpdfstring{\textbf{es} -- Español}{es -- Español}}\label{es-espauxf1ol}

\section{\texorpdfstring{\textbf{en} -- Inglés}{en -- Inglés}}\label{en-ingluxe9s}

\section{\texorpdfstring{\textbf{fr} -- Francés}{fr -- Francés}}\label{fr-francuxe9s}

\section{\texorpdfstring{\textbf{de} -- Alemán}{de -- Alemán}}\label{de-alemuxe1n}
...
\section{\texorpdfstring{\textbf{Gráfico Pixel} Genera y visualiza los gráficos asociados a un píxel seleccionado con tu cursor. Cuando pinchas en un punto de tu área de estudio, esta opción te mostrará los datos correspondientes a su Latitud, Longitud, m/píxel (muestra la resolución del mapa en ese nivel de zoom, en metros por píxel) y el nombre de la capa que estás visualizando.}{Gráfico Pixel Genera y visualiza los gráficos asociados a un píxel seleccionado con tu cursor. Cuando pinchas en un punto de tu área de estudio, esta opción te mostrará los datos correspondientes a su Latitud, Longitud, m/píxel (muestra la resolución del mapa en ese nivel de zoom, en metros por píxel) y el nombre de la capa que estás visualizando.}}\label{gruxe1fico-pixel-genera-y-visualiza-los-gruxe1ficos-asociados-a-un-puxedxel-seleccionado-con-tu-cursor.-cuando-pinchas-en-un-punto-de-tu-uxe1rea-de-estudio-esta-opciuxf3n-te-mostraruxe1-los-datos-correspondientes-a-su-latitud-longitud-mpuxedxel-muestra-la-resoluciuxf3n-del-mapa-en-ese-nivel-de-zoom-en-metros-por-puxedxel-y-el-nombre-de-la-capa-que-estuxe1s-visualizando.}
