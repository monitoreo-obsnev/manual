...
<!--chapter:end:07-sensor.Rmd-->

# Unidad de agregación temporal {#agregacion-temporal}
...
<!--chapter:end:08-agregacion-temporal.Rmd-->
...
<!--chapter:end:09-agregacion-espacial.Rmd-->
...
* **Media:** Calcula el **promedio** de los valores por año dentro del periodo de tiempo seleccionado.  
* **Mediana**: Calcula el **valor central** de los valores por año dentro del periodo de tiempo seleccionado. Es más resistente a valores extremos que la media.   
* **Mínimo:** Calcula el **valor más bajo** por año en un periodo de tiempo.  
* **Máximo:** Calcula el **valor más alto** por año en un periodo de tiempo.  
* **No calcular:** No calcula agregaciones temporales por años.

![](assets/interannualAggregation.png)

<!--chapter:end:10-agregacion-interanual.Rmd-->
