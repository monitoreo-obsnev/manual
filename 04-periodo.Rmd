...
La herramienta permite seleccionar **dos periodos** para realizar un análisis comparativo de una misma variable dentro del mismo ROI en distintas fechas.

Al activar esta opción, se mostrarán en los resultados **dos mapas y dos gráficas**, cada uno correspondiente a un periodo:

- El **Periodo 1** aparece en la parte inferior como *"Ref. Map"*  
- El **Periodo 2** aparece como *"Comp. Map"*
