...
\urlstyle{same}
\hypersetup{
  pdftitle={Manual de usuario de MonitorEO-OBSNEV - Biore},
...
=======
\title{Manual de usuario de MonitorEO-OBSNEV - Biore}
\author{Observatorio de Cambio Global de Sierra Nevada}
>>>>>>> a01edb76a4780c03a8ad45646308899f7fdb35ff
\date{2025-12-09}
...
\section{\texorpdfstring{\textbf{🌱️Bio-Refugios}}{🌱️Bio-Refugios}}\label{bio-refugios}

Puedes seleccionar la cuenca de interés dentro del proyecto Bio-Refugios
...
\subsection{Modelo de Pastos - PASSERA}\label{modelo-de-pastos---passera}

Explicación del modelo de pastos

\subsection{Modelo de Thed}\label{modelo-de-thed}

Explicación del modelo de Thed
