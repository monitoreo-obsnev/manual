...
\section{📆 Comparar con otro periodo}\label{comparar-con-otro-periodo}

La herramienta permite seleccionar \textbf{dos periodos} para realizar un análisis comparativo de una misma variable dentro del mismo ROI en distintas fechas.

Al activar esta opción, se mostrarán en los resultados \textbf{dos mapas y dos gráficas}, cada uno correspondiente a un periodo:

\begin{itemize}
\tightlist
\item
  El \textbf{Periodo 1} aparece en la parte inferior como \emph{``Ref. Map''}\\
\item
  El \textbf{Periodo 2} aparece como \emph{``Comp. Map''}
\end{itemize}

\section{📆 Selección de un intervalo específico}\label{selecciuxf3n-de-un-intervalo-especuxedfico}
